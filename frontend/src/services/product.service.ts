...
const allMockProducts = [
  // Tecnología
  { id: 1, nombre: 'MacBook Pro 16"', precio: 2499, precioOriginal: 2799, stockDisponible: 8, imagenes: [{ url: 'https://picsum.photos/200/300?random=1', esPrincipal: true }], categorias: [{ id: 1, nombre: 'Electrónica' }], marca: 'Apple', color: 'Gris Espacial', fechaCreacion: '2024-01-15', popularidad: 95, descripcion: 'Laptop profesional con chip M3 Pro', caracteristicas: ['Chip M3 Pro', '16GB RAM', '512GB SSD', 'Pantalla Retina 16"'] },
  { id: 2, nombre: 'Mouse Logitech MX Master 3', precio: 99, stockDisponible: 50, imagenes: [{ url: 'https://picsum.photos/200/300?random=2', esPrincipal: true }], categorias: [{ id: 1, nombre: 'Electrónica' }], marca: 'Logitech', color: 'Negro', fechaCreacion: '2024-02-10', popularidad: 88, descripcion: 'Mouse ergonómico para productividad', caracteristicas: ['Sensor 4000 DPI', 'Batería 70 días', 'Conexión USB-C', 'Scroll infinito'] },
